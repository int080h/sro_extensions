...
namespace ext_client::net_manager {
  ...
  auto record_outgoing(cmsg_stream_buffer* msg, bool blocked, bool modified, std::uint16_t opcode = 0) -> void;
  auto record_incoming(cmsg_stream_buffer* msg, bool blocked, bool modified, std::uint16_t opcode = 0) -> void;
  auto record_cmsg_outgoing(cmsg* pkt, bool blocked, bool modified, std::uint16_t opcode = 0) -> void;
  auto record_cmsg_incoming(cmsg* pkt, bool blocked, bool modified, std::uint16_t opcode = 0) -> void;
