...
namespace ext_client::cif_manager {
  ...
  auto walk(cgwnd* root, int max_depth = 32, int cginterface_probe_max_id = 0) -> std::vector<widget_info>;
  auto walk_static_texts(cgwnd* root, int max_depth = 32, int cginterface_probe_max_id = 0) -> std::vector<widget_info>;
