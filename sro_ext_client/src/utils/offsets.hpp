...
namespace ext_client::offsets {
  ...
  // Client mouse position written by the game each frame (sub_D70440 reads +0x50/+0x54).
  namespace input_state {
    inline constexpr std::uint32_t address = 0x013BAE04;

    namespace fields {
      inline constexpr std::size_t mouse_x = 0x050;
      inline constexpr std::size_t mouse_y = 0x054;
    } // namespace fields
  } // namespace input_state
  ...
  namespace cgwnd {
    ...
    namespace fields {
      ...
      inline constexpr std::size_t hit_pad_left = 0x050;
      inline constexpr std::size_t hit_pad_top = 0x054;
      inline constexpr std::size_t hit_pad_right = 0x058;
      inline constexpr std::size_t hit_pad_bottom = 0x05C;
    ...
    namespace functions {
      inline constexpr std::uint32_t get_manager = 0x00583100;            // CGWnd_GetManager
      inline constexpr std::uint32_t pick_at_point = 0x00D6CAA0;          // CGWnd hit-test (sub_D6CAA0)
      inline constexpr std::uint32_t refresh_interface_under_cursor = 0x00D70440; // sub_D70440 full hover sync
      inline constexpr std::uint32_t hit_test_contains = 0x00D6A830;      // bounds contains (sub_D6CAA0 tail)
      inline constexpr std::uint32_t is_visible = 0x00D6A990;              // m_visible @ +0x61
      inline constexpr std::uint32_t get_child_by_unique_id = 0x00407E50; // child_list walk by unique id
      inline constexpr std::uint32_t set_interface_under_cursor = 0x00D5DEC0;
      inline constexpr std::uint32_t create_outer_wnd = 0x00D62410;
  ...
  namespace cif_static {
    inline constexpr std::size_t size = 0x398; // CProcess_Allocate(0x394); pool block = 0x3A0
  ...
  namespace cif_wnd {
    ...
    namespace vtable {
      inline constexpr std::uint32_t address = 0x00FF46BC;   // ??_7CIFWnd@@6B@
      inline constexpr std::uint32_t secondary = 0x00FF4674; // ??_7CIFWnd@@6B@_0
      inline constexpr std::size_t method_count = 50;
    } // namespace vtable

    namespace fields {
      inline constexpr std::size_t textboard_vftable = 0x084;
    ...
    namespace functions {
      inline constexpr std::uint32_t ctor = 0x00730F50;
    } // namespace functions
  } // namespace cif_wnd

  // ======================================================================
  // ctextboard.hpp / cnif_textboard.hpp
  // ======================================================================
  namespace ctextboard {
    namespace vtable {
      inline constexpr std::uint32_t address = 0x00FF47F4; // ??_7CTextBoard@@6B@
      inline constexpr std::size_t method_count = 17;
    } // namespace vtable
  } // namespace ctextboard

  namespace cnif_wnd {
    inline constexpr std::size_t size = 0x34C;

    namespace vtable {
      inline constexpr std::uint32_t address = 0x01082FC4;   // ??_7CNIFWnd@@6B@
      inline constexpr std::uint32_t secondary = 0x01083094; // ??_7CNIFWnd@@6B@_0
      inline constexpr std::size_t method_count = 50;
    } // namespace vtable
  ...
  namespace cnif_textboard {
    namespace vtable {
      inline constexpr std::uint32_t address = 0x0108325C; // ??_7CNIFTextBoard@@6B@
      inline constexpr std::size_t method_count = 17;
    } // namespace vtable
  } // namespace cnif_textboard
  ...
  namespace cres_id_manager {
    ...
    namespace vtable {
      inline constexpr std::uint32_t address = 0x0103D2CC; // ??_7CResIDManager@@6B@
    } // namespace vtable

    namespace fields {
      inline constexpr std::size_t tree_head = 0x04;
      inline constexpr std::size_t field_08 = 0x08;
      inline constexpr std::size_t parsed_document = 0x0C;
      inline constexpr std::size_t field_24 = 0x24;
      inline constexpr std::size_t string_cap = 0x28;
      inline constexpr std::size_t field_2c = 0x2C;
    } // namespace fields
  ...
  // ======================================================================
  // cnif_page_manager.hpp
  // ======================================================================
  namespace cnif_page_manager {
    inline constexpr std::size_t size = 0x388;

    namespace vtable {
      inline constexpr std::uint32_t address = 0x01084CF4;   // ??_7CNIFPageManager@@6B@
      inline constexpr std::uint32_t secondary = 0x01084DC4; // ??_7CNIFPageManager@@6B@_0
      inline constexpr std::size_t primary_method_count = 50;
      inline constexpr std::size_t secondary_method_count = 17;
    } // namespace vtable

    namespace fields {
      inline constexpr std::size_t textboard_vftable = 0x084;
      inline constexpr std::size_t page_state_a = 0x34C;
      inline constexpr std::size_t page_state_b = 0x350;
      inline constexpr std::size_t page_state_c = 0x354;
      inline constexpr std::size_t page_flag_a = 0x358;
      inline constexpr std::size_t page_flag_b = 0x359;
      inline constexpr std::size_t page_flag_c = 0x35A;
      inline constexpr std::size_t page_id = 0x360;
      inline constexpr std::size_t page_color_a = 0x364;
      inline constexpr std::size_t page_color_b = 0x368;
      inline constexpr std::size_t page_embed_a = 0x36C;
      inline constexpr std::size_t page_embed_b = 0x370;
      inline constexpr std::size_t page_embed_c = 0x374;
      inline constexpr std::size_t page_embed_d = 0x378;
      inline constexpr std::size_t page_embed_e = 0x37C;
    } // namespace fields

    namespace functions {
      inline constexpr std::uint32_t allocate = 0x004302E0;
      inline constexpr std::uint32_t ctor = 0x00430380;
    } // namespace functions
  } // namespace cnif_page_manager

  // ======================================================================
  // cobj_render_manager.hpp
  // ======================================================================
  namespace cobj_render_manager {
    inline constexpr std::size_t size = 0x60;

    namespace vtable {
      inline constexpr std::uint32_t address = 0x01077254; // ??_7CObjRenderManager@@6B@ (dispatch table)
    } // namespace vtable

    namespace fields {
      inline constexpr std::size_t field_04 = 0x04;
      inline constexpr std::size_t field_08 = 0x08;
      inline constexpr std::size_t vec_a_begin = 0x38;
      inline constexpr std::size_t vec_a_end = 0x3C;
      inline constexpr std::size_t vec_a_cap = 0x40;
      inline constexpr std::size_t vec_b_begin = 0x50;
      inline constexpr std::size_t vec_b_end = 0x54;
      inline constexpr std::size_t vec_b_cap = 0x58;
      inline constexpr std::size_t field_5c = 0x5C;
    } // namespace fields

    namespace functions {
      inline constexpr std::uint32_t ctor = 0x00E02640;
      inline constexpr std::uint32_t dtor = 0x00DFAF00;
    } // namespace functions
  } // namespace cobj_render_manager
  ...
  // ======================================================================
  // centity_manager.hpp / centity_manager_client.hpp
  // ======================================================================
  namespace centity_manager {
    namespace vtable {
      inline constexpr std::uint32_t address = 0x010684C4; // ??_7CEntityManager@@6B@
      inline constexpr std::size_t method_count = 12;
    } // namespace vtable

    namespace globals {
      inline constexpr std::uint32_t singleton = 0x013BAE08; // dword_13BAE08
    } // namespace globals

    namespace fields {
      inline constexpr std::size_t field_20 = 0x20;
      inline constexpr std::size_t hash_map_a_head = 0x28;
      inline constexpr std::size_t hash_map_a_count = 0x2C;
      inline constexpr std::size_t hash_map_b_head = 0x34;
      inline constexpr std::size_t hash_map_b_count = 0x38;
      inline constexpr std::size_t flag_a = 0x3C;
      inline constexpr std::size_t flag_b = 0x3D;
      inline constexpr std::size_t uid_capacity = 0x40;
      inline constexpr std::size_t uid_buffer = 0x44;
      inline constexpr std::size_t entity_vec_begin = 0x3A8;
      inline constexpr std::size_t entity_vec_end = 0x3AC;
    } // namespace fields

    namespace functions {
      inline constexpr std::uint32_t ctor = 0x00D5CC60;
      inline constexpr std::uint32_t lookup_by_slot = 0x00793E80;
      inline constexpr std::uint32_t rebuild_uid_list = 0x00D5B6D0;
    } // namespace functions
  } // namespace centity_manager

  namespace centity_manager_client {
    namespace vtable {
      inline constexpr std::uint32_t address = 0x01040DF4; // ??_7CEntityManagerClient@@6B@
      inline constexpr std::size_t method_count = 36;
    } // namespace vtable

    namespace functions {
      inline constexpr std::uint32_t ctor = 0x00B24FE0;
      inline constexpr std::uint32_t rebuild_uid_list = 0x00B256E0;
      inline constexpr std::uint32_t lookup_entity_by_slot = 0x00B24030;
    } // namespace functions
  } // namespace centity_manager_client
  ...
  namespace cg_interface {
    ...
    inline constexpr std::size_t size = 0x98C;
    ...
    namespace child_ids {
      ...
      inline constexpr int target_panel = 0x10; // wnd_10 — sub_868030 → sub_7E6B60
    ...
    namespace fields {
      inline constexpr std::size_t textboard_vftable = 0x084;
      inline constexpr std::size_t gig_interface_vftable = textboard_vftable; // legacy alias
      ...
      inline constexpr std::size_t target_window = 0x3BC;
      inline constexpr std::size_t modal_wnd = 0x808;
      inline constexpr std::size_t modal_mode = 0x80C;
      inline constexpr std::size_t selected_target_id = modal_mode; // entity slot id (sub_85EEB0)
    ...
    namespace functions {
      ...
      inline constexpr std::uint32_t get_target_window = 0x0085D600;         // sub_85D600
      inline constexpr std::uint32_t get_selected_target_id = 0x0085EEB0;  // sub_85EEB0
      inline constexpr std::uint32_t get_component = 0x008831F0;           // sub_8831F0(CGInterface*) → get_ui_child(0x19)
    } // namespace functions
  } // namespace cg_interface

  // ======================================================================
  // Entity manager access path (wrapper @ +0x7C4, mgr lookup sub_781E10)
  // ======================================================================
  namespace entity_manager {
    namespace fields {
      inline constexpr std::size_t wrapper_ptr = 0x7C4;
      inline constexpr std::size_t entity_vec_begin = centity_manager::fields::entity_vec_begin;
      inline constexpr std::size_t entity_vec_end = centity_manager::fields::entity_vec_end;
    } // namespace fields

    namespace functions {
      inline constexpr std::uint32_t from_wrapper = 0x00781E10;   // sub_781E10(wrapper*) → mgr @ +0x7C4
      inline constexpr std::uint32_t lookup_by_slot = centity_manager::functions::lookup_by_slot;
      inline constexpr std::uint32_t lookup_entity_by_slot = centity_manager_client::functions::lookup_entity_by_slot;
      inline constexpr std::uint32_t unique_id = 0x009D5C20;      // sub_9D5C20
      inline constexpr std::uint32_t display_name_ptr = 0x009D5BC0; // sub_9D5BC0
      inline constexpr std::uint32_t refdata = 0x009D5BF0;        // sub_9D5BF0
    } // namespace functions

    namespace component_ids {
      inline constexpr int wrapper = 0x19; // get_component slot (alarm_store child id)
    } // namespace component_ids
  } // namespace entity_manager

  // ======================================================================
  // CIFTargetWindow (+ derived SpecialMob / CommonEnemy)
  // ======================================================================
  namespace cif_target_window {
    inline constexpr std::size_t size = 0x394; // through this+228 (sub_7E6B60)
    inline constexpr std::uint32_t vtable = 0x010053AC;

    namespace fields {
      inline constexpr std::size_t target_entity_id = 0x374; // this+221 — sub_7E8EB0 / sub_7E8C30
      inline constexpr std::size_t name_label = 0x378;       // this+222
      inline constexpr std::size_t hp_gauge = 0x37C;          // this+223
      inline constexpr std::size_t hp_percent_label = 0x380; // this+224 — SpecialMob rank / HP %
      inline constexpr std::size_t special_mob_panel = 0x388; // CIFTargetWindowSpecialMob — sub_7E8EB0 this
    } // namespace fields

    namespace gauge_fields {
      inline constexpr std::size_t fill_ratio = 920; // float 0..1 — sub_7E8C30 / sub_7E7F20
    } // namespace gauge_fields

    namespace functions {
      inline constexpr std::uint32_t populate_target = 0x007E6B60;           // CIFTargetWindow::OnUpdateTarget
      inline constexpr std::uint32_t populate_special_mob = 0x007E8EB0;      // CIFTargetWindowSpecialMob::OnUpdate
      inline constexpr std::uint32_t on_update_special_mob = 0x007E8C30;     // CIFTargetWindowSpecialMob::OnTimer
      inline constexpr std::uint32_t on_update_common_enemy = 0x007E7F20;    // CIFTargetWindowCommonEnemy
    } // namespace functions
  } // namespace cif_target_window

  namespace cif_target_window_common_enemy {
    inline constexpr std::size_t size = cif_target_window::size;
    inline constexpr std::uint32_t vtable = 0x01005614;

    namespace fields {
      inline constexpr std::size_t target_entity_id = cif_target_window::fields::target_entity_id;
      inline constexpr std::size_t overlay_label = cif_target_window::fields::name_label;
      inline constexpr std::size_t hp_gauge = cif_target_window::fields::hp_gauge;
      inline constexpr std::size_t hp_label = cif_target_window::fields::hp_percent_label;
    } // namespace fields
  } // namespace cif_target_window_common_enemy

  namespace cif_target_window_special_mob {
    inline constexpr std::size_t size = cif_target_window::size;
    inline constexpr std::uint32_t vtable = 0x01005A4C;
  ...
  namespace ci_charactor {
    namespace fields {
      ...
      inline constexpr std::size_t display_name = 0x0D0;
      inline constexpr std::size_t hp = 0x554;
      inline constexpr std::size_t mp = 0x558;
      inline constexpr std::size_t max_hp = 0x55C;
      inline constexpr std::size_t display_hp = 0x564; // sub_B287B0 — gauge / target window path
    ...
    namespace functions {
      ...
      inline constexpr std::uint32_t display_hp = 0x00B287B0; // sub_B287B0
    } // namespace functions
  } // namespace ci_charactor
