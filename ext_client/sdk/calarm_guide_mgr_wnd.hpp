...
public:
  ...
  // Policy & Internal Helper Methods promoted to class
  static auto active_targets() -> promo_target;
  static auto any_hide_active() -> bool;
  static auto should_block_guide(unsigned guide_id) -> bool;
  static auto should_block_slot(char slot_index) -> bool;
  static auto should_block_effect(unsigned char fx_index) -> bool;
  static auto apply_after_create(calarm_guide_mgr_wnd* mgr) -> void;
