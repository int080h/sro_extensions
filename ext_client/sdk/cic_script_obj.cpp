...
auto cic_script_obj::play_animation(int anim_id, int arg1, int arg2, int arg3, float speed, float start_time) -> void {
  ...
  if (!vtable || !ext_client::msvc9::is_readable_ptr(vtable, (ext_client::offsets::cic_script_obj::vtable::play_animation + 1) * sizeof(void*))) {
    return;
  }
  ...
  if (!play_anim || !ext_client::msvc9::is_readable_ptr(reinterpret_cast<const void*>(play_anim), 1)) {
    return;
  }
